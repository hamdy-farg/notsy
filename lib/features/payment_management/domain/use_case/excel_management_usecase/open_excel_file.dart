...
@injectable
class OpenExcelFile extends BaseParamsUseCase<String, File> {
  final ExcelManagementRepository excelManagementRepository;
  OpenExcelFile({required this.excelManagementRepository});

  @override
  Future<ApiResultModel<String>> call(file) async {
    return await excelManagementRepository.openExcelFile(file: file);
  }
}
